...
def main():
    ...
    try:
        # Change this string to whatever your model is named!
        # If you used the TensorBoard callback, it might be in "./sawblade_logs/best_model.zip"
    ...
    while running:
        ...
        if not game_over:
            ...
            # Translate game screen to math array
            ...
            # deterministic=True forces the AI to use its best learned strategy, stopping random exploration!
